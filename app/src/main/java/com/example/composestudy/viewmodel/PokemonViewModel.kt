...
import com.example.composestudy.service.PokemonResponse
import com.example.composestudy.service.Response
                ...
                override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Response.Result> {
                    try {
                        ...
                        return LoadResult.Page(
                            ...
                            nextKey = pokemons.next?.substringAfter("offset=")?.substringBefore("&")
                                ?.toInt()
                        )
                    } catch (e: Exception) {
                        Log.e("EEE", "error: $e")
